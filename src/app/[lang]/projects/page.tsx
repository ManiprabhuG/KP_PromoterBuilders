    ...
    <>
      <section className="bg-gradient-to-r from-[var(--primary-dark)] to-[var(--primary)] text-white py-16 text-center">
        <div className="container">
          <span className="badge badge-gold mb-3">Residential Layouts</span>
          <h1 className="text-4xl font-extrabold text-white mb-2">{dict.proj_title}</h1>
          <p className="text-slate-200 text-lg max-w-xl mx-auto">{dict.proj_desc}</p>
        </div>
      </section>
